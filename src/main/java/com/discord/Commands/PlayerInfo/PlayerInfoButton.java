...
public class PlayerInfoButton {
    ...
    public static void handleStats(ButtonInteractionEvent event) throws IOException {
    ...
    public static void handleBattleLog(ButtonInteractionEvent event) throws IOException {
        event.deferReply().queue();
        ...
        event.getHook().sendMessageEmbeds(embed.build())
                .addActionRow(Button.danger("playerInfo", "My Stats"))
                .queue();
    }
}
